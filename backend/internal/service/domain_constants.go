...
const (
	...
	// SettingKeyOpenAICandidateIndexSchedulerEnabled OpenAI 高级调度下是否启用候选索引调度引擎。
	SettingKeyOpenAICandidateIndexSchedulerEnabled          = "openai_candidate_index_scheduler_enabled"
	SettingKeyOpenAICandidateIndexSchedulerPageSize         = "openai_candidate_index_scheduler_page_size"
	SettingKeyOpenAICandidateIndexSchedulerMaxScan          = "openai_candidate_index_scheduler_max_scan"
