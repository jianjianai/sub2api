...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		SchedulerCandidateIndexEnabled:                         settings.SchedulerCandidateIndexEnabled,
		SchedulerCandidateIndexStatus:                          settings.SchedulerCandidateIndexStatus,
		SchedulerCandidateIndexError:                           settings.SchedulerCandidateIndexError,
		SchedulerCandidateFetchLimit:                           settings.SchedulerCandidateFetchLimit,
		SchedulerCandidateReadyWaitMS:                          settings.SchedulerCandidateReadyWaitMS,
		SchedulerCandidateBuildWaitMS:                          settings.SchedulerCandidateBuildWaitMS,
