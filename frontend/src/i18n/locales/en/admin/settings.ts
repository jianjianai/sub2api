export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        candidateIndexTitle: 'Intelligent Candidate Routing Engine',
        candidateIndexDescription: 'When enabled, OpenAI/Grok account selection switches from full snapshot scans to a compact Redis candidate pool. Failed, rate-limited, or timed-out accounts are removed from the pool quickly. Large pools, high concurrency, or noisy failure rates can see lower CPU usage, fewer Redis reads, and better P95 latency; small, quiet pools can keep it disabled.',
        candidateConfigTitle: 'Intelligent candidate routing config',
        candidateConfigDescription: 'Only request-path runtime parameters are exposed here. After saving, use the status badge to confirm whether the engine is actually active.',
        candidateFetchLimitLabel: 'Candidate read limit',
        candidateFetchLimitDescription: 'Maximum accounts read from the Redis candidate set per request. Higher values improve hit rate but increase per-request filtering and MGET cost.',
        candidateFetchLimitRecommendation: 'Recommended: under 30 accounts use 16-32; 30-200 use 64; 200-1000 use 96-128; over 1000 use 128-256. Minimum is 8.',
        candidateReadyWaitLabel: 'Ready propagation wait (ms)',
        candidateReadyWaitDescription: 'Waits briefly for the just-written ready marker to become visible across Redis or multiple gateway instances.',
        candidateReadyWaitRecommendation: 'Recommended: 100-200 for single-node or low-latency Redis; 300-500 for cross-region or higher-latency Redis.',
        candidateBuildWaitLabel: 'Missing-index build wait (ms)',
        candidateBuildWaitDescription: 'Maximum time a new request waits for targeted index build during startup recovery or missing bucket repair; timeout returns cache not ready.',
        candidateBuildWaitRecommendation: 'Recommended: 3000-5000 for small pools; 5000-10000 for medium pools; 10000-20000 for large pools.',
        candidateIndexDisabled: 'Disabled',
        candidateIndexBuilding: 'Switching',
        candidateIndexActive: 'Enabled',
        candidateIndexFailed: 'Failed',
        topKLabel: 'TopK',
